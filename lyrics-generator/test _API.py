...
model_filename = 'C:/Users/miste/Chat_bot/lyrics-generator/export/2024-01-10T200418/model.h5'
tokenizers_filename = 'C:/Users/miste/Chat_bot/lyrics-generator/export/2024-01-10T200418/tokenizer.pickle'
...
test_text = 'как дела?'
predict_text = lyrics(model_filename, tokenizers_filename, test_text, 42, 20)
...
def predict():
    ...
    test_answer = lyrics(model_filename, tokenizers_filename, text, length)
